...
export const SEGMENTS: Segment[] = [
  ...
  },
  {
    ...
    text: 'The receipt reports what this session observed, who caused it, and what it does not establish.',
  },
  {
    beat: 'probe',
    startSeconds: 135.2,
    ...
    text: 'Seven features, each executed live. Two Chrome accepts and silently does not honour.',
  },
]
