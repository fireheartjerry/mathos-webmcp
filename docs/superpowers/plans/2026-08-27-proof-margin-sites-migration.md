...
- [x] **Step 1: Write failing tests in `src/components/proofPresentation.test.ts`**
...
- [x] **Step 1: Replace `StepBadge` with a semantic relation block**
...
- [x] **Step 2: Move diagnosis, annotations, and proposal into `.line-evidence` inside each `<li>`**
...
- [x] **Step 3: Convert the line list into a responsive proof grid**
...
- [x] **Step 4: Run typecheck and the complete test suite**
...
- [x] **Step 1: Create `SessionDetails.tsx`**
...
- [x] **Step 2: Simplify `AgentConsole.tsx`**
...
- [x] **Step 1: Replace the frozen Sarsa token rationale in `tokens.css`**
...
- [x] **Step 2: Rewrite `scratchpad.css` as one coherent stylesheet**
...
- [x] **Step 3: Run source fingerprint checks**
...
- [x] **Step 2: Rewrite `src/styles/landing.css`**
...
- [x] **Step 3: Validate semantics and production output**
...
- [x] **Step 1: Start or reuse the production preview**

Run: `pnpm preview --host 127.0.0.1 --port 4322` and retain the session.

- [x] **Step 2: Open the existing coherent experience as the Sites first meaningful preview**
...
- [x] **Step 3: Inspect representative pixels**
...
- [x] **Step 4: Repeat until no high-severity visual/UX issue remains**
...
- [x] **Step 3: Write `07_SCREENSHOT_MATRIX.md`**
...
- [x] **Step 1: Dispatch isolated reviewers**
...
- [x] **Step 3: Math and state hostility**
...
- [x] **Step 4: Accessibility and interaction**
...
- [x] **Step 5: Write `09_ACCESSIBILITY_INTERACTION_AUDIT.md` and `10_FINAL_VERDICT.md`**
...
- [x] **Step 1: Inspect an official Sites scaffold outside the project**
...
- [x] **Step 2: Adapt the existing Astro/Vite project**
...
- [x] **Step 5: Push, package, save, and deploy the exact validated commit**
...
- [x] **Step 6: Poll to terminal success and verify the live replacement**
