...
| Builds and runs | **Ready** — `pnpm build` succeeds and 380 tests pass with a clean typecheck. |
...
- 380 tests, typecheck clean, production build green, zero console errors across the
